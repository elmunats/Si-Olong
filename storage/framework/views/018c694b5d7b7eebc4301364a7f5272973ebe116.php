...
<body class="login">
        ...
        <?php echo csrf_field(); ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-icon left">
                        <i class="icon-envelope"></i>
                        <input class="m-wrap placeholder-no-fix" type="text" placeholder="Email" id="email" name="email" value="<?php echo e(old('email')); ?>"/>
                    </div>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="form-actions">
                ...
                <?php echo link_to('auth/login','Back'
    ...
    <script src="<?php echo e(asset('assets/plugins/jquery-validation/dist/jquery.validate.js')); ?>" type="text/javascript"></script>
